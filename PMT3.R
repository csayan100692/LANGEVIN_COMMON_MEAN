...
PMT3=function(x,alpha)
{
  ...
  B5=l[1]*y[[1]]+l[2]*y[[2]]+l[3]*y[[3]]

  B1=sqrt(sum(B5**2))
  a1=(l[1]*r_bar1[1]*mu_hat_0[[1]]+l[2]*r_bar1[2]*mu_hat_0[[2]]+l[3]*r_bar1[3]*mu_hat_0[[3]])
  ...
  for(h in 1:H)
  {
    ...
    B3=l1[1]*z[[1]]+l1[2]*z[[2]]+l1[3]*z[[3]]
    B2=sqrt(sum(B3**2))


    b2=l1[1]*q_bar1[1]*(mu_hat_hat_0[[1]])+l1[2]*q_bar1[2]*(mu_hat_hat_0[[2]])+l1[3]*q_bar1[3]*(mu_hat_hat_0[[3]])
