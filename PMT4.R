...
PMT4=function(x,alpha)
{

  p=3
  k=4
  sequence_of_n=c(nrow(x[[1]]),nrow(x[[2]]),nrow(x[[3]]),nrow(x[[4]]))
  ...
  H1=rbind(x[[1]],x[[2]],x[[3]],x[[4]])
  A4=sum(l*r_bar1)

  B5=l[1]*y[[1]]+l[2]*y[[2]]+l[3]*y[[3]]+l[4]*y[[4]]

  B1=sqrt(sum(B5**2))
  a1=(l[1]*r_bar1[1]*mu_hat_0[[1]]+l[2]*r_bar1[2]*mu_hat_0[[2]]+l[3]*r_bar1[3]*mu_hat_0[[3]]+l[4]*r_bar1[4]*mu_hat_0[[4]])
  ...
  for(h in 1:H)
  {
    ...
    g[[1]] <- H2[1:sequence_of_n[1],]
    g[[2]] <- H2[sequence_of_n[1]+1:sequence_of_n[2],]
    g[[3]] <- H2[sequence_of_n[2]+1:sequence_of_n[3],]
    g[[4]] <- H2[sequence_of_n[3]+1:sequence_of_n[4],]
    ...
    B3=l1[1]*z[[1]]+l1[2]*z[[2]]+l1[3]*z[[3]]+l1[4]*z[[4]]
    B2=sqrt(sum(B3**2))


    b2=l1[1]*q_bar1[1]*(mu_hat_hat_0[[1]])+l1[2]*q_bar1[2]*(mu_hat_hat_0[[2]])+l1[3]*q_bar1[3]*(mu_hat_hat_0[[3]])+l1[4]*q_bar1[4]*(mu_hat_hat_0[[4]])
